...
public class Lookup implements Serializable {
     ...
     *
     * @param connector {@link Connector} instance, not {@code null}
     * @return parsed {@link Response} from iTunes
    ...
    /**
     * @param id an iTunes item id, can be {@code null}
    ...
    /**
     * @param ids a {@link Collection} of iTunes item ids, can be {@code null}
     *            or empty
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param amgArtistId an All Music artist id, can be {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param amgArtistIds a {@link Collection} of All Music artist ids, can be
     *                     {@code null} or empty
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param amgAlbumId an All Music album id, can be {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param amgAlbumIds a {@link Collection} of All Music album ids, can be
     *                    {@code null} or empty
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param amgVideoId an All Music video id, can be {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param amgVideoIds a {@link Collection} of All Music video ids, can be
     *                    {@code null} or empty
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param upc a UPC, can be {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param upcs a {@link Collection} of UPCs, can be
     *             {@code null} or empty
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param isbn an ISBN, can be {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param isbns a {@link Collection} of ISBNs, can be
     *              {@code null} or empty
     * @return {@code this} instance for method chaining
     */
    ...
    public Lookup setMedia(Media media) {
        this.media = media;
        return this;
    }
    ...
    /**
     * @param entity an {@link Entity}, or {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param limit the maximum number of results to include in the response
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param sort a {@link Sort} instance, or {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    /**
     * @param country a {@link Country} instance, or {@code null}
     * @return {@code this} instance for method chaining
     */
    ...
    public String build() {
		...
		if (media != null) {
			...
			sb.append("media").append("=").append(media.getName());
		}
        if (entity != null) {
            if (sb.length() > 0) {
                sb.append("&");
